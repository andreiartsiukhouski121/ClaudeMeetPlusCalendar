...
**параллельно** — каждая в своём worktree и со своим диапазоном портов
(`E2E_WEB_PORT` / `E2E_API_PORT`). В первой итерации последовательный запуск бэкенда и веба стоил
42 минуты там, где хватило бы 23.
