...
| ID     | Дата       | Дефект                                                                                                                                               | Коммит                                                | Чем найдено |
| ------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ----------- |
| FX-022 | 2026-09-08 | `LG-API-03` определял графу коммита **по содержимому** и принимал за неё описание записи `FX-019`, где слово `pending` стоит в тексте                | прогон CI                                             | `pending`   |
