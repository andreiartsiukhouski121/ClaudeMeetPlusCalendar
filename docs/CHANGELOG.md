...
| ------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | --------- |
| FX-020 | 2026-09-08 | `pnpm ledger:fill` ставил всем записям хеш `HEAD`: запись, введённая предыдущим коммитом, получала чужой                                             | попытка заполнить запись, названную `LG-API-03` на CI | `pending` |
| FX-019 | 2026-09-08 | Инвариант `9c526a9` делал **первый push любой новой записи красным по построению**: на CI дерево всегда чистое, а хеш заполняется следующим коммитом | первый прогон CI                                      | `pending` |
