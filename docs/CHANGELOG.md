...
| ID     | Дата       | Что                                                                                                                                                                                      | Коммит    |
| ------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| CH-013 | 2026-09-16 | Два именованных потока работ: скил `bugfix-pipeline` и шаблон `TEMPLATE-BUGFIX.md` (`pnpm plan:new <slug> --bug`), фазы названы в `feature-pipeline`, развилка «фича или баг» в правилах | `pending` |
