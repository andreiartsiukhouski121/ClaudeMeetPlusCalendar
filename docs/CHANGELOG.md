...
| ------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | --------- |
| FX-021 | 2026-09-08 | `pnpm ledger:fill` заменял **первое вхождение** `pending` в строке, а не графу хеша: у записи, где это слово стоит в описании, испортилось описание  | ручная сверка после прогона `ledger:fill`             | `pending` |
