...
description: Порядок работ для фичи в этом монорепозитории — ориентация, спайк допущений, компактный план, одно ревью, реализация, приёмка. Use when starting a new feature or a set of features, when planning implementation, when asked "запланируй фичу", "реализуй фичу", "сделай фичи по скрину", or when a multi-agent pipeline is requested.
---
...
По шаблону `docs/plans/TEMPLATE.md`, **100–150 строк**, поверх фактов спайка. Чего в плане быть не
